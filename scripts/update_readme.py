...
QUOTES = [
    ...
    ("Build something that matters. Not something that trends.", "RNSL"),
    ("The best way to predict the future is to create it.", "Alan Kay"),
    ("Everything around you that you call life was made up by people no smarter than you.", "Steve Jobs"),
    ("We create what has never existed. That is the only mission that matters.", "RNSL"),
    ("Move fast. Not because speed is the goal — because waiting is surrender.", "RNSL"),
    ("A ship in harbor is safe, but that is not what ships are for.", "John A. Shedd"),
    ("If you are not embarrassed by the first version of your product, you've launched too late.", "Reid Hoffman"),
    ("The ones who are crazy enough to build from nothing are the only ones who ever do.", "RNSL"),
    ("Conviction is a more powerful resource than capital.", "RNSL"),
]
